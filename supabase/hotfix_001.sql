-- =====================================================================
-- Hotfix 001: rename local var `bet_count` in recompute_capper.
-- Original collides with the `bet_count` column in the UPDATE statement,
-- causing: "column reference 'bet_count' is ambiguous".
